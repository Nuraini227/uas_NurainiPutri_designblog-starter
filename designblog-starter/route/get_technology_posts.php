<?php
// Pengaturan koneksi ke database (sama seperti sebelumnya)
...
// Query untuk mengambil artikel dari kategori Technology dengan pagination
...
// Menghitung total jumlah postingan dalam kategori Technology
$sql_count = "SELECT COUNT(*) as total FROM articles WHERE category = 'Technology'";
